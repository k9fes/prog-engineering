...
<img width="756" height="1080" alt="image" src="https://github.com/user-attachments/assets/f6d18b74-2eb7-4ecc-930f-bfeacc593597" />

### Вывод
Программа демонстрирует правильное применение принципов объектно-ориентированного программирования.
# Общий вывод
В ходе выполнения были успешно освоены и практически применены фундаментальные концепции объектно-ориентированного программирования. Каждое задание демонстрировало конкретный аспект ООП, что позволило комплексно понять принципы построения объектно-ориентированных систем.
